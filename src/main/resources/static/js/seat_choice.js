...
nextPage.addEventListener("click", () => {
	...
	const name = document.getElementById('concert-name');
	const place = document.getElementById('concert-place');
	const date = document.getElementById('concert-date');
	...
	sessionStorage.setItem("concertInfo", JSON.stringify(priceInfo));
